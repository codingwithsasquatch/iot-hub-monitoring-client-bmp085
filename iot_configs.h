 ...
 * WiFi setup
 */
#define IOT_CONFIG_WIFI_SSID            "<ssid here>"
#define IOT_CONFIG_WIFI_PASSWORD        "<password here>"
 ...
 */
#define IOT_CONFIG_CONNECTION_STRING    "HostName=...;DeviceId=...;SharedAccessKey=..."
